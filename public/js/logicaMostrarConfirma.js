$(document).ready(function () {
    $("#table_confirma").DataTable({
        ordering: false,
        lengthChange: false,
    });
    $("#actaconf").click(function () {
        Swal.fire({
            icon: "error",
            title: "Oops...",
    ...
    $(".modal").modal();
    $(document).on("click", ".show-modalg_con", function () {
        $("#padri").empty();
        $("#padres").empty();
        ...
        $("#obispo_confirma").text($(this).data("obispo_confirma"));

        $("#dia_con").text($(this).data("dia_con"));
        $("#mes_con").text($(this).data("mes_con"));
        $("#anio_con").text($(this).data("anio_con"));
