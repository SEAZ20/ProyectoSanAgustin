$(document).ready(function () {
    ...
    $("#dynamic_form_comu1").on("submit", function (event) {
                                ...
                                success: function (data) {
                                    if (data.error) {
                                        ...
                                        Swal.fire({
                                            ...
                                            icon: "success",
                                            title:
                                                "Comunión registrado Correctamente",
    ...
    $("#dynamic_form_comu2").on("submit", function (event) {
        event.preventDefault();
        if (
            $("#nombres").val() == "" ||
            $("#apellidos").val() == "" ||
            ...
            if ($("#nota").val() == "") {
                ...
                if (
                    ...
                    Swal.fire({
                        ...
                        title: "Error...",
                        text:
                            "Año de nacimiento, bautizo o comunión no pueden ser mayor al actual!",
                    });
                } else {
                    if (
                        $("#ecle_anio").val() > fecha.getFullYear() &&
