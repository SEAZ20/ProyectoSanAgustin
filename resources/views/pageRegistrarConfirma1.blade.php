    ...
    <div class="col s12 m12">
      <div class="card">
        <div class="card-content">
            <form method="POST" id="dynamic_form_confirma1">
                {{ csrf_field() }}
                ...
                <div class="row ">
                    <div class="input-field col s3">
                        <select id="mes_con" name="mes_con" required>
                          <option value="" disabled selected>Mes de Confirmación</option>
                    ...
                    <div class="input-field col s2">
                        <select id="dia_con" name="dia_con" required>
                            <option value="" disabled selected>Día de Confirmación</option>
                    ...
                    <div class="input-field col s2">
                        ...
                        <label for="anio_co">Año de Confirmación</label>
                    </div>
                    <div class="input-field col s5">
